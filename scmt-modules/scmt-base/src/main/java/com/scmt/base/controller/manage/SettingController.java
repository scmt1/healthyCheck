...
public class SettingController {
    ...
    @SystemLog(description = "查看私密配置", type = LogType.OPERATION)
    ...
    @SystemLog(description = "检查OSS配置", type = LogType.OPERATION)
    ...
    @SystemLog(description = "查看OSS配置", type = LogType.OPERATION)
    ...
    @SystemLog(description = "查看短信配置", type = LogType.OPERATION)
    ...
    @SystemLog(description = "查看短信模板配置", type = LogType.OPERATION)
    ...
    @SystemLog(description = "查看vaptcha配置", type = LogType.OPERATION)
    ...
    @SystemLog(description = "查看email配置", type = LogType.OPERATION)
    ...
    @SystemLog(description = "查看其他配置", type = LogType.OPERATION)
    ...
    @SystemLog(description = "查看公告配置", type = LogType.OPERATION)
    ...
    @SystemLog(description = "OSS配置", type = LogType.OPERATION)
    ...
    @SystemLog(description = "短信配置", type = LogType.OPERATION)
    ...
    @SystemLog(description = "email配置", type = LogType.OPERATION)
    ...
    @SystemLog(description = "vaptcha配置", type = LogType.OPERATION)
    ...
    @SystemLog(description = "其他配置", type = LogType.OPERATION)
