...
import com.scmt.core.service.RoleService;
...
public class RoleController {
    ...
    @SystemLog(description = "编辑角色分配菜单权限", type = LogType.OPERATION)
    ...
    @SystemLog(description = "编辑角色分配数据权限", type = LogType.OPERATION)
    ...
    @SystemLog(description = "保存数据", type = LogType.OPERATION)
    ...
    @SystemLog(description = "更新数据", type = LogType.OPERATION)
