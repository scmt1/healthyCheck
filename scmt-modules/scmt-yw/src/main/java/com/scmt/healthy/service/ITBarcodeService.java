 ...
 *@author
 **/
public interface ITBarcodeService extends IService<TBarcode> {
	...
	*/
	...
	TBarcode getTBarcodeByPersonId(String personId,String testNum);

	TBarcode getTBarcodeByPersonIdAndItemId(String personId,String groupItemId,String testNum);
